 ...
 * `v0.9123 banana xD` is now baked once via env, rendered beside the
 ...
 * ("<image-tag> v0.9123 banana xD"). The Cloud Run revision (K_REVISION) is a
...
describe("Task 3.1 — header identifier is coherent with /api/version", () => {
  it("getAppVersion exposes the exact manual identifier `v0.9123 banana xD`", () => {
