/**
 * Dependency injection helpers for the silences pass-through route.
...
let currentDeps: SilencesRouteDeps = defaultDeps;

export function getDeps(): SilencesRouteDeps {
  return currentDeps;
}

export function __setDeps(deps: Partial<SilencesRouteDeps>): void {
